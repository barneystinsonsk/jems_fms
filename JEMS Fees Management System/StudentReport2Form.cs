...
{
    public partial class StudentReport2Form : Form
    {
        List<String> sessionArray;
        List<String> sessionIndex;
        public StudentReport2Form()
        {
            InitializeComponent();
        }
        ...
        private void go_Click(object sender, EventArgs e)
        {
            ...
            {
                this.student_detailsTableAdapter.Fill(this.StudentReport2DataSet.student_details, class1, class2, "A", "B", "C", "D", "E", cat1, cat2, cat3, cat4, sessionIndex[sessionBox.SelectedIndex]);
            ...
            else if (section.SelectedIndex > 0)
            {
                ...
                this.student_detailsTableAdapter.Fill(this.StudentReport2DataSet.student_details, class1, class2, s[val], s[val], s[val], s[val], s[val], cat1, cat2, cat3, cat4, sessionIndex[sessionBox.SelectedIndex]);
        ...
        private void StudentReport2Form_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'StudentReport2DataSet.student_details' table. You can move, or remove it, as needed.
            //this.student_detailsTableAdapter.Fill(this.StudentReport2DataSet.student_details,);
        ...
        private void StudentReport2Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            MainForm.sr2Form = null;
        }
    }
}
